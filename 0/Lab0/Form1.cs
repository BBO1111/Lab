    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (button2.BackColor == Color.Yellow&& button1.BackColor == Color.Yellow)
                {
                    double y;
               ...
               else if(button2.BackColor == Color.White&& button1.BackColor == Color.White)
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (isNum==false||isNum1==false||String.IsNullOrEmpty(textBox1.Text)|| String.IsNullOrEmpty(textBox3.Text)||isNum2==false|| String.IsNullOrEmpty(textBox2.Text)||isNum3==false|| String.IsNullOrEmpty(textBox3.Text))
            {
                textBox4.Text = "Помилка! Введить коректні дані";
                    ...
                    if (button1.BackColor==Color.White && button2.BackColor == Color.White)
                    {
                        double a = Convert.ToDouble(textBox1.Text);
                        double x = Convert.ToDouble(textBox3.Text);
                        double y;
                    ...
                    else if(button1.BackColor == Color.Yellow&& button2.BackColor == Color.Yellow)
                    {
                    double a = Convert.ToDouble(textBox1.Text);
                    double b = Convert.ToDouble(textBox2.Text);
                    double x = Convert.ToDouble(textBox3.Text);
